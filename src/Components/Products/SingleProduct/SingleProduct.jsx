            ...
            <div className="row">
                ...
                <div className="d-flex justify-content-around">
                  {Product.images.map((imgpath, index) => (
                    <img
                      ...
                      key={index}
                      style={{
                        opacity: SelectedImage === index ? "100%" : "50%",
                        border:
                          SelectedImage === index ? "3px solid #A5D4CB" : "",
                      }}
                      alt=""
                      srcset=""
                    />
              ...
              <div className="col-md-6 col-lg-4">
                ...
                <div className="d-flex py-4">
                  ...
                  />
                  <button onClick={()=>addProductToCart(Product.id)} className={`${Style.add_to_cart_button}`}>
                    Add to cart
                  </button>
                </div>
                <hr />
              ...
              <div className="col-3">
                <div className={`${Style.Category}`}>
                  ...
                  <div className="d-flex flex-column">
                    {Products.slice(9, 13).map((CurProduct) => (
                      <ProductBunnerCard Product={CurProduct} />
                    ))}
                  </div>
                </div>
              </div>
